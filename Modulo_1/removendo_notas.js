...
notas.pop();
console.log("Notas após remover o último elemento: " + notas);
//array.pop() => remove o ultimo elemento da lista.

let media = (notas[0]+ notas[1] + notas[2]+ notas[3])/notas.length;
console.log("Média das notas: " + media);

//Outro métodos com array
/*
...
indexOf(): Localiza e retorna o índice referente à primeira ocorrência de determinado valor em um array. Caso não exista nenhuma ocorrência do valor, retorna -1.
